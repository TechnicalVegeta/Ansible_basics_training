...
def run_module():
    ...
    if not encode_status and not decode_status:
        module.fail_json(
            msg='bad input , it should be encode or decode', **result)

    # Change string to base64 and return it
    if encode_status:
        message = module.params['name']
        message_byte = message.encode('ascii')
        base64_bytes_string = str(base64.b64encode(message_byte))

    # result to show it
        result['orginal_message'] = message
    ...
    if decode_status:
        ...
        base64_bytes_string = str(base64.b64decode(base64_byte))

    # result to show it
        result['orginal_message'] = base64_message
        result['decoded_message'] = base64_bytes_string
        result['message'] = "your data is decoded to normal string. enjoy!!"
